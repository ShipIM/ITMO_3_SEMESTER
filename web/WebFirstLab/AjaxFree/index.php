<?php
    ...
    require_once('php/CachedResultable.php');
    require_once('php/Row.php');
    require_once('php/NumberContainer.php');
    require_once('php/Timer.php');
    require_once('php/RadioContainer.php');
    require_once('php/TextFieldContainer.php');
    require_once('php/CachedContainable.php');
            ...
            <td id="content_table_container">
                <table>
                    ...
                    <?php
                        ...
                        //Надо убрать параметры GET запроса из строки браузера + добавить отправку времени одним из параметров запроса.
                    ?>
                </table>
            </td>
        </tr>
